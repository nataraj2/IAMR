...

{
    ...
    for (MFIter Rho_mfi(rho_ctime,true); Rho_mfi.isValid(); ++Rho_mfi)
    {
        ...
        getForce(tforces,bx,n_grow,Xvel,BL_SPACEDIM,cur_time,U_new[Rho_mfi],U_new[Rho_mfi],Density,hori_avg);
        ...
        //std::cout << "HERE 5......." << hori_avg << "\n";
{
		...
		if (getForceVerbose) amrex::Print() << "Calling getForce..." << '\n';
                getForce(tforces,bx,0,sigma,1,halftime,Vel,Scal,0,hori_avg);
    ...
    //std::cout << "HERE 6......." << hori_avg << "\n";
{
      ...
      getForce(tforces,bx,1,Xvel,BL_SPACEDIM,prev_time,Umf[U_mfi],Smf[U_mfi],0,hori_avg);
    ...
    //std::cout << "HERE 1......." << hori_avg << "\n";
{
	...
	if (getForceVerbose)
        ...
        getForce(tforces,bx,0,Xvel,BL_SPACEDIM,half_time,Vel,Scal,0,hori_avg);
	  ...
	  const Box& bx = mfi.tilebox();
	    ...
	    if (getForceVerbose)
	    {
	      amrex::Print() << "---" << '\n' 
            ...
            getForce(tforces,bx,0,Xvel,BL_SPACEDIM,prev_time,U_old[mfi],U_old[mfi],Density,hori_avg);
