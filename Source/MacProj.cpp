...
#pragma omp parallel 
#endif
    hori_avg = ns_level.calcHorizontalAvg();
...

    {
      ...
      for (MFIter Smfi(Smf,true); Smfi.isValid(); ++Smfi)
      {
        ...
        ns_level.getForce(tforces,bx,1,0,NUM_STATE,prev_time,Smf[Smfi],Smf[Smfi],Density,hori_avg);
        ...
        {
            ns_level.getForce(tvelforces,bx,1,Xvel,BL_SPACEDIM,prev_time,Smf[Smfi],Smf[Smfi],Density,hori_avg);
